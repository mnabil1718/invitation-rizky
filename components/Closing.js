    ...
    return (
        <section style={{ backgroundImage: 'url("/png/paper2.png")' }} className="relative text-neutral">
            <div className="relative max-w-screen-sm mx-auto text-center">
                ...
                <div className="absolute mt-2 top-1/2 left-10 transform -scale-x-100">
                ...
                <div className='transform rotate-20 mb-14'>
                    <Image className='drop-shadow-md' src="/png/letter.png" alt="Love letter" width={100} height={100} />
                </div>
